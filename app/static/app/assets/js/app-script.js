...
// retrieve the selected theme from local storage and set as default background color
function theme(themeNumber) {
  $('body').attr('class', 'bg-theme bg-theme' + themeNumber);
  localStorage.setItem('theme', 'bg-theme bg-theme' + themeNumber);
  // save the theme in local storage without page reload
  localStorage.setItem('theme', 'bg-theme bg-theme' + themeNumber);
}
$(document).ready(function () {
